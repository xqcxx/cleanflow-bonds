...
export default function Home() {
  ...
  useEffect(() => {
    fetch("/deployments/unichain-sepolia.json")
      .then((response) => response.json())
      .then((value: Deployment) => {
        setDeployment(value);
      ...
      <section className="lab">
        ...
        <div className="lab-grid">
          ...
          <aside className="metrics">
            ...
            <div className="claim-row"><button disabled={!ready || busy || claimable === 0n} onClick={claimTrader}>CLAIM TRADER</button><button disabled={!ready || busy || !executionId} onClick={claimLp}>CLAIM LP</button></div>
          </aside>
        </div>
      </section>
